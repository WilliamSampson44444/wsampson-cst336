...
function getImageURLs($keyword, $orientation) {
    ...
    curl_setopt_array($curl, array(
      CURLOPT_URL => "https://pixabay.com/api/?key=2553050-a6a7e4ee33de285ff2bac9d0e&q=$keyword&image_type=photo&orientation=$orientation&safesearch=true&per_page=100",
